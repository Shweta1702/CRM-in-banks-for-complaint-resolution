...
/<div class="container-fluid">
  <div class="row content">
	...
	<li><a href="crud.php">Get Services</a></li>
        ...
        <li><a href="#status.php">Status and Analytics of Complaint resolution</a></li>
    ...
    <div class="col-sm-9">
      <div class="well">
        ...
        <p>Does the account include any perks?</p>
<p>How often do your change your interest rates?</p>
<p>Can I access my money while traveling?</p>
<p>Where is my money being invested?</p>
</p>What values does the institution stand by?</p>
<p>Is the bank the planet’s friend or foe?</p>
      </div>
      <div class="row">
        <div class="col-sm-3">
          <div class="well">
